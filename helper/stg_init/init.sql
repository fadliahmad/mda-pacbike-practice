CREATE TABLE public.shipmethod (
...
ALTER TABLE ONLY public.shipmethod
...
CREATE TABLE public.salesorderheadersalesreason (
    salesorderid integer NOT NULL,
    salesreasonid integer NOT NULL,
    modifieddate timestamp without time zone DEFAULT now() NOT NULL,
    created_at timestamp without time zone DEFAULT now() NOT NULL
);
CREATE TABLE public.specialofferproduct (
    specialofferid integer NOT NULL,
    productid integer NOT NULL,
    rowguid uuid  NOT NULL,
    modifieddate timestamp without time zone DEFAULT now() NOT NULL,
...
CREATE TABLE public.salespersonquotahistory (
    businessentityid integer NOT NULL,
...
CREATE TABLE public.salesreason (
    salesreasonid integer NOT NULL,
    name text NOT NULL,
...
CREATE TABLE public.salesterritoryhistory (
    businessentityid integer NOT NULL,
    territoryid integer NOT NULL,
    startdate timestamp without time zone NOT NULL,
...
CREATE SEQUENCE public.currencyrate_currencyrateid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.currencyrate_currencyrateid_seq OWNED BY public.currencyrate.currencyrateid;
...
CREATE SEQUENCE public.salesreason_salesreasonid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.salesreason_salesreasonid_seq OWNED BY public.salesreason.salesreasonid;
...
CREATE SEQUENCE public.salesterritory_territoryid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.salesterritory_territoryid_seq OWNED BY public.salesterritory.territoryid;
...
CREATE SEQUENCE public.shoppingcartitem_shoppingcartitemid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.shoppingcartitem_shoppingcartitemid_seq OWNED BY public.shoppingcartitem.shoppingcartitemid;
...
CREATE SEQUENCE public.specialoffer_specialofferid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.specialoffer_specialofferid_seq OWNED BY public.specialoffer.specialofferid;
...
ALTER TABLE ONLY public.currencyrate ALTER COLUMN currencyrateid SET DEFAULT nextval('public.currencyrate_currencyrateid_seq'::regclass);
...
ALTER TABLE ONLY public.salesreason ALTER COLUMN salesreasonid SET DEFAULT nextval('public.salesreason_salesreasonid_seq'::regclass);
...
ALTER TABLE ONLY public.salesterritory ALTER COLUMN territoryid SET DEFAULT nextval('public.salesterritory_territoryid_seq'::regclass);
...
ALTER TABLE ONLY public.shoppingcartitem ALTER COLUMN shoppingcartitemid SET DEFAULT nextval('public.shoppingcartitem_shoppingcartitemid_seq'::regclass);
...
ALTER TABLE ONLY public.specialoffer ALTER COLUMN specialofferid SET DEFAULT nextval('public.specialoffer_specialofferid_seq'::regclass);
...
SELECT pg_catalog.setval('public.currencyrate_currencyrateid_seq', 1, false);
...
SELECT pg_catalog.setval('public.salesorderdetail_salesorderdetailid_seq', 1, false);
...
SELECT pg_catalog.setval('public.salesorderheader_salesorderid_seq', 1, false);
...
SELECT pg_catalog.setval('public.salesreason_salesreasonid_seq', 1, false);
...
SELECT pg_catalog.setval('public.salesterritory_territoryid_seq', 1, false);
...
SELECT pg_catalog.setval('public.shoppingcartitem_shoppingcartitemid_seq', 1, false);
...
SELECT pg_catalog.setval('public.specialoffer_specialofferid_seq', 1, false);
...
ALTER TABLE public.person CLUSTER ON "PK_Person_BusinessEntityID";


ALTER TABLE ONLY public.employee
    ADD CONSTRAINT "PK_Employee_BusinessEntityID" PRIMARY KEY (businessentityid);

ALTER TABLE public.employee CLUSTER ON "PK_Employee_BusinessEntityID";
...
ALTER TABLE public.product CLUSTER ON "PK_Product_ProductID";
...
ALTER TABLE public.currencyrate CLUSTER ON "PK_CurrencyRate_CurrencyRateID";
...
ALTER TABLE public.customer CLUSTER ON "PK_Customer_CustomerID";
...
ALTER TABLE public.salesorderdetail CLUSTER ON "PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID";
...
ALTER TABLE ONLY public.salesorderheadersalesreason
    ADD CONSTRAINT "PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID" PRIMARY KEY (salesorderid, salesreasonid);

ALTER TABLE public.salesorderheadersalesreason CLUSTER ON "PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID";
...
ALTER TABLE public.salesorderheader CLUSTER ON "PK_SalesOrderHeader_SalesOrderID";
...
ALTER TABLE ONLY public.salespersonquotahistory
    ADD CONSTRAINT "PK_SalesPersonQuotaHistory_BusinessEntityID_QuotaDate" PRIMARY KEY (businessentityid, quotadate);

ALTER TABLE public.salespersonquotahistory CLUSTER ON "PK_SalesPersonQuotaHistory_BusinessEntityID_QuotaDate";
...
ALTER TABLE public.salesperson CLUSTER ON "PK_SalesPerson_BusinessEntityID";
...
ALTER TABLE ONLY public.salesreason
    ADD CONSTRAINT "PK_SalesReason_SalesReasonID" PRIMARY KEY (salesreasonid);

ALTER TABLE public.salesreason CLUSTER ON "PK_SalesReason_SalesReasonID";
...
ALTER TABLE ONLY public.salesterritoryhistory
...
ALTER TABLE public.salesterritoryhistory CLUSTER ON "PK_SalesTerritoryHistory_BusinessEntityID_StartDate_TerritoryID";
...
ALTER TABLE ONLY public.salesterritory
    ADD CONSTRAINT "PK_SalesTerritory_TerritoryID" PRIMARY KEY (territoryid);

ALTER TABLE public.salesterritory CLUSTER ON "PK_SalesTerritory_TerritoryID";
...
ALTER TABLE public.shoppingcartitem CLUSTER ON "PK_ShoppingCartItem_ShoppingCartItemID";
...
ALTER TABLE ONLY public.specialofferproduct
    ADD CONSTRAINT "PK_SpecialOfferProduct_SpecialOfferID_ProductID" PRIMARY KEY (specialofferid, productid);

ALTER TABLE public.specialofferproduct CLUSTER ON "PK_SpecialOfferProduct_SpecialOfferID_ProductID";
...
ALTER TABLE public.specialoffer CLUSTER ON "PK_SpecialOffer_SpecialOfferID";
...
ALTER TABLE public.store CLUSTER ON "PK_Store_BusinessEntityID";
...
ALTER TABLE ONLY public.employee
    ADD CONSTRAINT "FK_Employee_Person_BusinessEntityID" FOREIGN KEY (businessentityid) REFERENCES public.person(businessentityid);
...
ALTER TABLE ONLY public.customer
    ADD CONSTRAINT "FK_Customer_Person_PersonID" FOREIGN KEY (personid) REFERENCES public.person(businessentityid);
...
ALTER TABLE ONLY public.customer
    ADD CONSTRAINT "FK_Customer_SalesTerritory_TerritoryID" FOREIGN KEY (territoryid) REFERENCES public.salesterritory(territoryid);
...
ALTER TABLE ONLY public.customer
    ADD CONSTRAINT "FK_Customer_Store_StoreID" FOREIGN KEY (storeid) REFERENCES public.store(businessentityid);
...
ALTER TABLE ONLY public.salesorderdetail
    ADD CONSTRAINT "FK_SalesOrderDetail_SpecialOfferProduct_SpecialOfferIDProductID" FOREIGN KEY (specialofferid, productid) REFERENCES public.specialofferproduct(specialofferid, productid);
...
ALTER TABLE ONLY public.salesorderheadersalesreason
    ADD CONSTRAINT "FK_SalesOrderHeaderSalesReason_SalesOrderHeader_SalesOrderID" FOREIGN KEY (salesorderid) REFERENCES public.salesorderheader(salesorderid) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.salesorderheadersalesreason
    ADD CONSTRAINT "FK_SalesOrderHeaderSalesReason_SalesReason_SalesReasonID" FOREIGN KEY (salesreasonid) REFERENCES public.salesreason(salesreasonid);
...
ALTER TABLE ONLY public.salesorderheader
    ADD CONSTRAINT "FK_SalesOrderHeader_CurrencyRate_CurrencyRateID" FOREIGN KEY (currencyrateid) REFERENCES public.currencyrate(currencyrateid);
...
ALTER TABLE ONLY public.salesorderheader
    ADD CONSTRAINT "FK_SalesOrderHeader_SalesPerson_SalesPersonID" FOREIGN KEY (salespersonid) REFERENCES public.salesperson(businessentityid);
...
ALTER TABLE ONLY public.salesorderheader
    ADD CONSTRAINT "FK_SalesOrderHeader_SalesTerritory_TerritoryID" FOREIGN KEY (territoryid) REFERENCES public.salesterritory(territoryid);
...
ALTER TABLE ONLY public.salesorderheader
    ADD CONSTRAINT "FK_SalesOrderHeader_ShipMethod_ShipMethodID" FOREIGN KEY (shipmethodid) REFERENCES public.shipmethod(shipmethodid);
...
ALTER TABLE ONLY public.salespersonquotahistory
    ADD CONSTRAINT "FK_SalesPersonQuotaHistory_SalesPerson_BusinessEntityID" FOREIGN KEY (businessentityid) REFERENCES public.salesperson(businessentityid);
...
ALTER TABLE ONLY public.salesperson
    ADD CONSTRAINT "FK_SalesPerson_Employee_BusinessEntityID" FOREIGN KEY (businessentityid) REFERENCES public.employee(businessentityid);
...
ALTER TABLE ONLY public.salesperson
    ADD CONSTRAINT "FK_SalesPerson_SalesTerritory_TerritoryID" FOREIGN KEY (territoryid) REFERENCES public.salesterritory(territoryid);
...
ALTER TABLE ONLY public.salesterritoryhistory
    ADD CONSTRAINT "FK_SalesTerritoryHistory_SalesPerson_BusinessEntityID" FOREIGN KEY (businessentityid) REFERENCES public.salesperson(businessentityid);
...
ALTER TABLE ONLY public.salesterritoryhistory
    ADD CONSTRAINT "FK_SalesTerritoryHistory_SalesTerritory_TerritoryID" FOREIGN KEY (territoryid) REFERENCES public.salesterritory(territoryid);
...
ALTER TABLE ONLY public.shoppingcartitem
    ADD CONSTRAINT "FK_ShoppingCartItem_Product_ProductID" FOREIGN KEY (productid) REFERENCES public.product(productid);
...
ALTER TABLE ONLY public.specialofferproduct
    ADD CONSTRAINT "FK_SpecialOfferProduct_Product_ProductID" FOREIGN KEY (productid) REFERENCES public.product(productid);
...
ALTER TABLE ONLY public.specialofferproduct
    ADD CONSTRAINT "FK_SpecialOfferProduct_SpecialOffer_SpecialOfferID" FOREIGN KEY (specialofferid) REFERENCES public.specialoffer(specialofferid);
...
ALTER TABLE ONLY public.store
    ADD CONSTRAINT "FK_Store_SalesPerson_SalesPersonID" FOREIGN KEY (salespersonid) REFERENCES public.salesperson(businessentityid);
